...
FH_SW_CRN.SURR=new Array(CUSMC_W_ENT,FH_NW_CRN);
CUSMC_W_ENT.SURR=new Array(FH_SW_CRN,CUSMC_E_SIDE);
CUSMC_E_SIDE.SURR=new Array(CUSMC_W_ENT,GY_NW_CRN,PATH_BETW_SMC_GY);
GY_NW_CRN.SURR=new Array(CUSMC_E_SIDE,PATH_BETW_SMC_GY);
